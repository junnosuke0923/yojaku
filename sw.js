const CACHE = 'yojaku-2026-09-05 20:04'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-MITANHge.js","./assets/index-CCcOBi8z.css"]
/*
  覚えたものを探すときの、ゆるめかた。
