const CACHE = 'yojaku-2026-09-06 07:21'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-DHqoKZQF.js","./assets/index-DF4FfV1b.css"]
/*
  覚えたものを探すときの、ゆるめかた。
