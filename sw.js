const CACHE = 'yojaku-2026-09-04 16:32'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-6suw3eAk.js","./assets/index-BetYPwOc.css"]
/*
  覚えたものを探すときの、ゆるめかた。
