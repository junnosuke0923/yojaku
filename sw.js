const CACHE = 'yojaku-2026-09-05 21:56'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-H-aK3XsE.js","./assets/index-Dw_g8-tv.css"]
/*
  覚えたものを探すときの、ゆるめかた。
