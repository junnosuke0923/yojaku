const CACHE = 'yojaku-2026-09-04 12:56'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-DSqG-5ro.js","./assets/index-D6zUpQjg.css"]
/*
  覚えたものを探すときの、ゆるめかた。
