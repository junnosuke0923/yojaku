const CACHE = 'yojaku-2026-09-04 16:52'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-q86dgj8L.js","./assets/index-ffjIWroU.css"]
/*
  覚えたものを探すときの、ゆるめかた。
