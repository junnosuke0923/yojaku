const CACHE = 'yojaku-2026-09-05 09:51'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-CAQ3ZDM5.js","./assets/index-CpRwXWn_.css"]
/*
  覚えたものを探すときの、ゆるめかた。
