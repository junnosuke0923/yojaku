const CACHE = 'yojaku-2026-09-05 21:14'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-B0uRlA-m.js","./assets/index-CCcOBi8z.css"]
/*
  覚えたものを探すときの、ゆるめかた。
