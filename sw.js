const CACHE = 'yojaku-2026-09-05 17:20'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-C69SRVyy.js","./assets/index-BgDGHjra.css"]
/*
  覚えたものを探すときの、ゆるめかた。
