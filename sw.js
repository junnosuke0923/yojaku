const CACHE = 'yojaku-2026-09-05 11:22'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-gOvMWkfl.js","./assets/index-Bl8-vXER.css"]
/*
  覚えたものを探すときの、ゆるめかた。
