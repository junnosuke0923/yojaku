const CACHE = 'yojaku-2026-09-05 16:40'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-C7dzDihI.js","./assets/index-BgDGHjra.css"]
/*
  覚えたものを探すときの、ゆるめかた。
