const CACHE = 'yojaku-2026-09-04 23:48'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-BDKgekTE.js","./assets/index-DI01BzhC.css"]
/*
  覚えたものを探すときの、ゆるめかた。
