const CACHE = 'yojaku-2026-09-16 10:08'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./icon-maskable-512.png","./sample-photo.jpg","./assets/index-CQKlu9pu.js","./assets/index-B2jwY45Z.css"]
/*
  覚えたものを探すときの、ゆるめかた。
