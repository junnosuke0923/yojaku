const CACHE = 'yojaku-2026-09-05 10:49'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-DWjHYHIW.js","./assets/index-CTbtidHe.css"]
/*
  覚えたものを探すときの、ゆるめかた。
