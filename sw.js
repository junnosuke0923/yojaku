const CACHE = 'yojaku-2026-09-05 10:42'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-io20bztZ.js","./assets/index-CpRwXWn_.css"]
/*
  覚えたものを探すときの、ゆるめかた。
