const CACHE = 'yojaku-2026-09-03 00:23'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-DigwoX18.js","./assets/index-CoXh5euC.css"]
/*
  覚えたものを探すときの、ゆるめかた。
