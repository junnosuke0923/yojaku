const CACHE = 'yojaku-2026-09-04 10:51'
const FILES = ["./","./index.html","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./sample-photo.jpg","./assets/index-DdTJPYOT.js","./assets/index-CJf8W0id.css"]
/*
  覚えたものを探すときの、ゆるめかた。
