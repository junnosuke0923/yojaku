...
const SHAPES: Record<IconName, ReactNode> = {
  ...
  */
  ...
  /*
    ...
    矢じりは、**弧の終わりの接線に沿った左右対称の折れ線**にする
    （依頼者の指摘・2026-09-04「この矢印がおかしな形をしています」）。
    はじめは縦と横の直角に折った線を置いていたため、
    進む向き（ここでは斜め上）とどこも揃っておらず、
    矢の先ではなく取っ手か注ぎ口のように見えていた。
    弧の終わりの点で接線を求め、その逆向きから左右へ 45 度、
    という「1つ戻る／1つ進む」とまったく同じ作り方に直してある
  */
  turnLeft: (
    <>
      <path d="M5 12A7 7 0 1 0 8.6 5.9" />
      <path d="M13 7.2L8.6 5.9 9.9 1.5" />
    </>
  ),
  turnRight: (
    <>
      <path d="M19 12A7 7 0 1 1 15.4 5.9" />
      <path d="M11 7.2L15.4 5.9 14.1 1.5" />
    </>
  ),
}
