  ...
  ruler: [
    {
      ...
      body: '写真から定規をさがして、枠を当ててあります。ずれていたら角を押したまま動かして直してください。ここがこのあとの寸法のもとになります。',
    },
    {
      target: 'ruler-kind',
      title: '使った定規は、どちらですか',
  ...
  */
  parts: [
    ...
    },
    {
      target: 'seam-steps',
      title: '選んだ辺を、ここで決めます',
      body: '数字は縫い代の量（cm）。もう縫い代が付いている型紙は、まとめて 0 cm にしてください。',
    },
    {
      target: 'seam-fold',
      title: '生地の折り山に当てる辺は「わ」',
      body: '前中心など、生地を折った山に当てて裁つ辺です。縫い代は付かず、1つの型紙に1辺だけ選べます。',
    },
    {
      target: 'seam-open',
  ...
  layout: [
    ...
    },
    {
      target: 'fabric',
      title: 'これが生地です',
      body: '上下の波線が、はさみで切る裁ち端。左右の細い帯がみみです。置いた型紙は、指で押したまま動かせます。上の断面図の辺を押すと、折り山の位置を変えられます。',
    },
    {
      target: 'tray',
      title: '押すと、生地の上に出ます',
